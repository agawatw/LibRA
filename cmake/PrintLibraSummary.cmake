...
macro(print_libra_summary)
  ...
  message("   Sakura:   ${LIBRA_SAKURA_GIT_REPOSITORY} @ ${LIBRA_SAKURA_GIT_TAG}")
  ...
  message("   Exodus Source:    ${LIBRA_EXODUS_SOURCE_DIR}")
  message("   Install Lib Dir:  ${CMAKE_INSTALL_LIBDIR}")
  message("   Install Inc Dir:  ${CMAKE_INSTALL_INCLUDEDIR}")
  message("   Install Bin Dir:  ${CMAKE_INSTALL_BINDIR}")
  message("   RPATH use link:   ${CMAKE_INSTALL_RPATH_USE_LINK_PATH}")
  message("   RPATH use origin: ${CMAKE_BUILD_RPATH_USE_ORIGIN}")
  message("   IPO:              ${CMAKE_INTERPROCEDURAL_OPTIMIZATION}")
  message("")
  message("   --- Options ---")
  if(LIBRA_ENABLE_CUDA_BACKEND)
  ...
  message("   LIBRA_ENABLE_CUDA_BACKEND: ${LIBRA_ENABLE_CUDA_BACKEND}")
  if(NOT LIBRA_ENABLE_CUDA_BACKEND)
    message("      CUDA backend is OFF: will attempt to build CPU backend with OpenMP")
  endif()
